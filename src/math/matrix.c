...
{
    jp_math_matrix *self = (jp_math_matrix *) jmalloc(sizeof (jp_math_matrix));
    assert(self);
...
jp_math_matrix_test (bool verbose)
{
    ...
    jp_math_matrix *self = jp_math_matrix_new();
    jassert(self);
    jp_math_matrix_destroy(&self);
    //  @end
    puts("OK!\n");
}
